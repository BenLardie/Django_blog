...
"""
from blog.views import root, home_page, open_blog, create_comment, new_article, login_view, logout_view, signup, create_article
...
urlpatterns = [
    ...
    path('article/new/', new_article, name="new_product"),
